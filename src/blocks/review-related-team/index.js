/**
 * Review Related Team Block Variation
 *
 * Registers a block variation for displaying reviews related to the current team member.
...
wp.domReady(() => {
    const registerReviewRelatedTeamVariation = () => {
        wp.blocks.registerBlockVariation('core/group', {
            name: 'lsx-tour-operator/review-related-team',
            title: __('Related Reviews', 'to-team'),
            icon: 'admin-users',
            description: __('Display reviews related to this team member.', 'to-team'),
            ...
            attributes: {
                ...
                className: 'lsx-review-related-team-query-wrapper',
                align: 'full',
                layout: {
                    type: 'constrained',
                },
                        ...
                        [
                            ...
                            [
                                [
                                    'core/post-template',
                                    {
                                        className: 'lsx-review-related-team-query',
                                        layout: {
                                            type: 'grid',
                                            columnCount: 3,
                                        },
                ...
                innerBlocks: [
                    {
                        ...
                        innerBlocks: [
                            ...
                            },
                            {
                                ...
                                attributes: {
                                    textAlign: 'center',
                                    content: __('Related Review', 'to-team'),
                                    level: 2,
                                },
                            },
                            {
    ...
    const conditionalRegister = registerForPostTypesAndTemplates(
        ['team'],
        ['team'],
        registerReviewRelatedTeamVariation
    );
    conditionalRegister();
});
