...
Yes; the TO Team plugin will work with any theme, but may require some styling to make it match nicely. Please see our [codex](https://tour-operator.lsdev.biz/documentation/) for help.
= Where can I report bugs or contribute to the project? =
Bugs can be reported either in our support forum or preferably on the [TO Team GitHub repository](https://github.com/lightspeeddevelopment/to-team/issues/).
